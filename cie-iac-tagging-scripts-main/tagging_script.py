            ...
            for resource in page.get("ResourceTagMappingList", []):
                ...
                csv_queue.put(
                    [
                        ...
                        region,
                        tags.get("mmsystem", ""),
                        tags.get("mmapplication", ""),
                        tags.get("mmenvironment", ""),
                        tags.get("mmcluster", ""),
                        tags.get("mminstance", ""),
                        tags.get("mmapptier", ""),
                    ]
...
def main(csv_path, s3_bucket=None, s3_prefix=""):
    ...
    filename = f"AllAccounts_Tagging_Report_{timestamp}.csv"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--csv", required=True, help="Path to CSV file with account_id and regions"
    )
    parser.add_argument(
    ...
    main(args.csv, args.s3_bucket, args.s3_prefix)
